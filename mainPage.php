                    ...
                    if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        ...
                        if ($cardItem != null) {
                            if ($cardItem["longTerm"] == 1 && $cardItem["remainTimes"] == 0) {
                                ...
                                $lastTrans = DBUtil::getInstance()->getLastTransaction();
                                if ($lastTrans != null && $lastTrans['cardCode'] == $cardCode) {
                                    echo("<div class='alert alert-danger'><h3><center><strong>Lỗi!</strong> Thẻ Quét 2 Lần Liên Tiếp.!</center></h3></div>");
                                } else {
