...
<html>
    ...
    <body>        
        ...
        <input class="btn btn-success" type="<?php if ($userType == 'Admin') echo 'button'; else echo 'hidden'; ?>" value="Danh sách giáo viên" onClick="document.location.href = 'listTeacher.php'" />     
        <input class="btn btn-success" type="<?php if ($userType == 'Admin') echo 'button'; else echo 'hidden'; ?>" value="Danh sách giảng dạy" onClick="document.location.href = 'listTeacherPlan.php'" />     
        <input class="btn btn-success" type="<?php if ($userType == 'Admin') echo 'button'; else echo 'hidden'; ?>" value="Thống kê tiền dạy" onClick="document.location.href = 'tienday.php'" />     
        </center>
    </body>
