...
<html>
    ...
    <body>
        ...
        <br/>
        <input class="btn btn-success" type="<?php if ($userType == 'Admin') echo 'button'; else echo 'hidden'; ?>" value="Thêm mới giáo viên" onClick="document.location.href = 'newTeacher.php'" />     
